	...
	INSERT INTO transport_organizer VALUES (300, 400, 'MakExpress', '1234512345125');
	...
	INSERT INTO route (route_id, transport_organizer_id, from_location_id, to_location_id) VALUES
	(100, 100, 100, 300),
	(200, 200, 100, 200),
	(300, 200, 200, 300),
	(400, 200, 300, 200),
...
INSERT INTO trip (trip_id, route_id, transport_organizer_id, free_seats, date, status) VALUES
(400, 100, 100, 33, '2025-02-12', 'NOT_STARTED'),
...
INSERT INTO trip_stops (trip_stop_id, trip_id, location_id, stop_time) VALUES
	(300, 400, 300, '19:00'),
	(400, 400, 100, '20:00'),
	(500, 500, 200, '15:30'),
	(600, 500, 100, '16:45'),
...
(3115, 2520, 300, '08:00');
	...
	INSERT INTO payment (payment_id, account_id, date, total_price, n_tickets) VALUES
	(100, 300, '02-02-2025', 20.98, 2),
...
INSERT INTO ticket (ticket_id, trip_id, gets_on_location_id, gets_off_location_id, account_id, date_purchased, time_purchased, price, seat, payment_id) VALUES
	(301, 500, 100, 200, 300, '08-08-2025', '10:45', 12.50, '12A', 200),
...
VALUES
    (810, 100, 900, 300), -- Struga to Skopje
    (811, 100, 900, 400); -- Struga to Veles
-- Insert trips
INSERT INTO trip (trip_id, route_id, transport_organizer_id, free_seats, date, status)
VALUES
    (2900, 100, 100, 40, '2026-03-01', 'NOT_STARTED'), -- Ohrid -> Bitola -> Kicevo -> Skopje
    ...
    (2904, 810, 100, 38, '2026-03-05', 'NOT_STARTED'); -- Struga -> Ohrid -> Skopje
