...
INSERT INTO transport_organizer
VALUES (300, 400, 'MakExpress', '1234512345125');
...
VALUES (400, 100, 100, 33, '2025-02-12', 'NOT_STARTED'),
       (500, 200, 100, 40, '2025-03-02', 'NOT_STARTED'),
       (600, 200, 300, 6, '2025-05-02', 'NOT_STARTED'),
       (700, 100, 300, 13, '2025-01-12', 'NOT_STARTED'),
       (800, 200, 300, 50, '2025-09-02', 'NOT_STARTED'),
       (900, 200, 300, 6, '2025-10-02', 'NOT_STARTED'),
       (1000, 100, 100, 25, '2025-02-15', 'NOT_STARTED'),
       (1100, 200, 300, 18, '2025-02-16', 'NOT_STARTED'),
       (1200, 200, 200, 40, '2025-02-20', 'NOT_STARTED'),
       (1300, 100, 300, 50, '2025-02-25', 'NOT_STARTED'),
       (1400, 100, 300, 20, '2025-02-26', 'NOT_STARTED'),
       (1500, 200, 100, 35, '2025-02-27', 'NOT_STARTED'),
       (1600, 200, 200, 28, '2025-02-28', 'NOT_STARTED'),
       (1700, 100, 300, 40, '2025-03-01', 'NOT_STARTED'),
       (1800, 100, 100, 18, '2025-03-02', 'NOT_STARTED'),
       (1900, 200, 300, 25, '2025-03-03', 'NOT_STARTED'),
       (2000, 200, 200, 22, '2025-03-04', 'NOT_STARTED'),
       (2100, 100, 100, 30, '2025-03-05', 'NOT_STARTED'),
       (2200, 200, 300, 12, '2025-03-06', 'NOT_STARTED'),
       (2300, 100, 100, 55, '2025-03-07', 'NOT_STARTED'),
       (2400, 100, 100, 45, '2025-01-15', 'COMPLETED'),
       (2401, 200, 200, 38, '2025-01-16', 'COMPLETED'),
       (2402, 300, 200, 42, '2025-01-17', 'COMPLETED'),
       (2403, 400, 200, 35, '2025-01-18', 'COMPLETED'),
       (2404, 500, 200, 28, '2025-01-19', 'COMPLETED'),
       (2405, 600, 100, 33, '2025-01-20', 'COMPLETED'),
       (2406, 700, 300, 40, '2025-01-21', 'COMPLETED'),
       (2407, 800, 100, 45, '2025-01-22', 'COMPLETED'),
       (2408, 801, 100, 30, '2025-01-23', 'COMPLETED'),
       (2409, 802, 100, 25, '2025-01-24', 'COMPLETED'),
       (2410, 803, 200, 40, '2025-01-25', 'COMPLETED'),
       (2411, 804, 200, 35, '2025-01-26', 'COMPLETED'),
       (2412, 805, 200, 30, '2025-01-27', 'COMPLETED'),
       (2413, 806, 300, 45, '2025-01-28', 'COMPLETED'),
       (2414, 807, 300, 38, '2025-01-29', 'COMPLETED'),
       (2415, 808, 100, 42, '2025-01-30', 'COMPLETED'),
       (2416, 809, 200, 35, '2025-01-31', 'COMPLETED'),
       (2500, 100, 100, 20, '2025-02-01', 'COMPLETED'),
       (2501, 200, 200, 15, '2025-02-01', 'COMPLETED'),
       (2502, 300, 200, 18, '2025-02-01', 'COMPLETED'),
       (2503, 400, 200, 22, '2025-02-01', 'COMPLETED'),
       (2504, 500, 200, 25, '2025-02-01', 'COMPLETED'),
       (2505, 100, 100, 18, '2025-02-02', 'COMPLETED'),
       (2506, 200, 200, 12, '2025-02-02', 'COMPLETED'),
       (2507, 300, 200, 20, '2025-02-02', 'COMPLETED'),
       (2508, 700, 300, 30, '2025-02-02', 'COMPLETED'),
       (2509, 800, 100, 35, '2025-02-02', 'COMPLETED'),
       (2510, 100, 100, 25, '2025-02-03', 'COMPLETED'),
       (2511, 200, 200, 20, '2025-02-03', 'COMPLETED'),
       (2512, 300, 200, 15, '2025-02-03', 'COMPLETED'),
       (2513, 801, 100, 28, '2025-02-03', 'COMPLETED'),
       (2514, 802, 100, 22, '2025-02-03', 'COMPLETED'),
       (2515, 100, 100, 30, '2025-02-04', 'COMPLETED'),
       (2516, 200, 200, 25, '2025-02-04', 'COMPLETED'),
       (2517, 400, 200, 18, '2025-02-04', 'COMPLETED'),
       (2518, 803, 200, 40, '2025-02-04', 'COMPLETED'),
       (2519, 804, 200, 35, '2025-02-04', 'COMPLETED'),
       (2520, 100, 100, 22, '2025-02-05', 'COMPLETED'),
       (2521, 300, 200, 28, '2025-02-05', 'COMPLETED'),
       (2522, 500, 200, 32, '2025-02-05', 'COMPLETED'),
       (2523, 805, 200, 25, '2025-02-05', 'COMPLETED'),
       (2524, 806, 300, 38, '2025-02-05', 'COMPLETED'),

       (2600, 100, 100, 35, '2025-03-08', 'NOT_STARTED'),
       (2601, 200, 200, 40, '2025-03-08', 'NOT_STARTED'),
       (2602, 300, 200, 32, '2025-03-08', 'NOT_STARTED'),
       (2603, 700, 300, 45, '2025-03-08', 'NOT_STARTED'),
       (2604, 800, 100, 38, '2025-03-08', 'NOT_STARTED'),
       (2605, 100, 100, 30, '2025-03-09', 'NOT_STARTED'),
       (2606, 400, 200, 35, '2025-03-09', 'NOT_STARTED'),
       (2607, 500, 200, 40, '2025-03-09', 'NOT_STARTED'),
       (2608, 801, 100, 25, '2025-03-09', 'NOT_STARTED'),
       (2609, 802, 100, 28, '2025-03-09', 'NOT_STARTED'),
       (2610, 200, 200, 42, '2025-03-10', 'NOT_STARTED'),
       (2611, 300, 200, 38, '2025-03-10', 'NOT_STARTED'),
       (2612, 803, 200, 45, '2025-03-10', 'NOT_STARTED'),
       (2613, 804, 200, 40, '2025-03-10', 'NOT_STARTED'),
       (2614, 807, 300, 35, '2025-03-10', 'NOT_STARTED'),

       (2700, 100, 100, 40, '2025-04-12', 'NOT_STARTED'),
       (2701, 200, 200, 35, '2025-04-12', 'NOT_STARTED'),
       (2702, 300, 200, 38, '2025-04-12', 'NOT_STARTED'),
       (2703, 400, 200, 42, '2025-04-12', 'NOT_STARTED'),
       (2704, 500, 200, 45, '2025-04-12', 'NOT_STARTED'),
       (2705, 600, 100, 30, '2025-04-13', 'NOT_STARTED'),
       (2706, 700, 300, 35, '2025-04-13', 'NOT_STARTED'),
       (2707, 800, 100, 40, '2025-04-13', 'NOT_STARTED'),
       (2708, 801, 100, 32, '2025-04-14', 'NOT_STARTED'),
       (2709, 802, 100, 28, '2025-04-14', 'NOT_STARTED'),

       (2800, 100, 100, 45, '2025-05-15', 'NOT_STARTED'),
       (2801, 200, 200, 40, '2025-05-15', 'NOT_STARTED'),
       (2802, 300, 200, 35, '2025-05-16', 'NOT_STARTED'),
       (2803, 400, 200, 38, '2025-05-16', 'NOT_STARTED'),
       (2804, 500, 200, 42, '2025-05-17', 'NOT_STARTED'),
       (2805, 700, 300, 40, '2025-05-17', 'NOT_STARTED'),
       (2806, 800, 100, 35, '2025-05-18', 'NOT_STARTED'),
       (2807, 803, 200, 45, '2025-05-18', 'NOT_STARTED'),
       (2808, 804, 200, 38, '2025-05-19', 'NOT_STARTED'),
       (2809, 807, 300, 40, '2025-05-19', 'NOT_STARTED');
...
VALUES (301, 500, 100, 200, 300, '08-08-2025', '10:45', 12.50, '12A', 200),
       ...
       (306, 700, 300, 100, 300, '04-02-2025', '12:15', 11.00, '20B', 200),
       (307, 800, 100, 300, 300, '05-02-2025', '13:10', 14.00, '25A', 200),
       (308, 800, 200, 100, 300, '05-02-2025', '13:20', 14.00, '25B', 200),
       (309, 900, 300, 100, 300, '06-02-2025', '14:40', 9.50, '30A', 200),
       (310, 900, 200, 300, 300, '06-02-2025', '14:50', 9.50, '30B', 200),
       (311, 900, 600, 200, 300, '06-02-2025', '15:10', 9.50, '30C', 200),
       (100, 400, 100, 100, 300, '02-02-2025', '10:03', 10.99, '3', 100),
...
VALUES (100, 1003, 'Helpful and fast.', 5),
       (200, 1008, 'Could improve.', 3),
       (300, 1013, 'Excellent support.', 5),
       (100, 1019, 'Satisfactory service.', 4),
       (200, 1024, 'Not happy.', 2),
       (300, 1030, 'Very good.', 5),
       (100, 1042, 'Average.', 3),
       (200, 1051, 'Helpful.', 4),
       (300, 1063, 'Could be better.', 2),
       (100, 1075, 'Amazing service.', 5),
       (200, 1082, 'Okay experience.', 3),
       (300, 1095, 'Very satisfied.', 5),
       (100, 1107, 'Mediocre support.', 2),
       (200, 1113, 'Excellent.', 5),
       (300, 1128, 'Good job.', 4),
       (100, 1135, 'Not great.', 2),
       (200, 1142, 'Very helpful.', 5),
       (300, 1156, 'Could improve.', 3),
       (100, 1163, 'Outstanding.', 5),
       (200, 1178, 'Average.', 3),
       (300, 1185, 'Happy.', 4),
       (100, 1192, 'Okay.', 3),
       (200, 1205, 'Needs improvement.', 2),
       (300, 1215, 'Excellent support!', 5),
       (100, 1222, 'Good experience.', 4),
       (200, 300, 'Quick response.', 4),
       (300, 301, 'Helpful staff.', 5),
       (100, 302, 'Could be better.', 3),
       (200, 303, 'Great service.', 5),
       (300, 304, 'Average.', 3),
       (100, 305, 'Not satisfied.', 2),
       (200, 306, 'Very happy.', 5),
       (300, 307, 'Mediocre.', 3),
       (100, 308, 'Excellent support!', 5),
       (200, 309, 'Okay.', 3),
       (300, 310, 'Good experience.', 4),
       (100, 311, 'Needs improvement.', 2),
       (200, 200, 'Happy with help.', 4),
       (300, 200, 'Could improve.', 3),
       (100, 1004, 'Outstanding.', 5),
       (200, 1011, 'Average service.', 3),
       (300, 1016, 'Very satisfied.', 5),
       (100, 1021, 'Not bad.', 4),
       (200, 1029, 'Could be better.', 3),
       (300, 1036, 'Excellent.', 5),
       (100, 1048, 'Good.', 4),
       (200, 1057, 'Needs work.', 2),
       (300, 1068, 'Very helpful.', 5),
       (100, 1072, 'Okay.', 3),
       (200, 1087, 'Outstanding support.', 5),
       (300, 1093, 'Average experience.', 3),
       (100, 1105, 'Happy.', 4);
